...
namespace raspberly.ovr
{
    public class FollowHUD : MonoBehaviour
    {
        ...
        [SerializeField] private float followMoveSpeed = 1; //0.1f
        [SerializeField] private float followRotateSpeed = 1; //0.02f
        [SerializeField] private float rotateSpeedThreshold = 1; //0.9f
